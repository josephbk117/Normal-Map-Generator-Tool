...
namespace ImGui
{
	...
	/** Custom ImageButton Func added to allow multiple ImageButons to be kept interactable if same ImTextureID is being used*/
	IMGUI_API bool          ImageButton(ImTextureID user_texture_id, unsigned char customId,const ImVec2& size, const ImVec2& uv0 = ImVec2(0, 0), const ImVec2& uv1 = ImVec2(1, 1), int frame_padding = -1, const ImVec4 & bg_col = ImVec4(0, 0, 0, 0), const ImVec4 & tint_col = ImVec4(1, 1, 1, 1));
